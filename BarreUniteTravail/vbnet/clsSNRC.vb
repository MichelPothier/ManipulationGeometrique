...
#Region " Routines et fonctions publiques"
    ...
    ''' 
    Public Sub New(ByVal pPoint As ESRI.ArcGIS.Geometry.IPoint, Optional ByVal nEchelle As Integer = 50000)
        'Définir la catégorie
        gsCategorie = "SNRC"
        'Définir le numéro Snrc
    ...
    '''<returns>Vrai si le SNRC est valide, faux sinon.</returns>
    '''
    Public Function Definir(ByVal pPoint As ESRI.ArcGIS.Geometry.IPoint, Optional ByVal nEchelle As Integer = 50000) As Boolean
        Try
            'Écrire une trace de début
            ''Call citsMod_FichierTrace.EcrireMessageTrace("Debut")
...
#Region " Routines et fonctions privées utilisé pour le calcul du SNRC à partir d'une point géographique et d'une échelle"
    ...
    '''</remarks>
    ''' 
    Private Function GET_SHEET_GEOG(ByVal pPoint As ESRI.ArcGIS.Geometry.IPoint, ByVal ECHELLE As Integer) As String
    ...
    ''' 
    Private Sub SECTEUR(ByVal pPoint As ESRI.ArcGIS.Geometry.IPoint, ByRef NTSA() As Integer, ByRef NTSB() As Integer, ByRef NTSC() As Integer, ByRef NTSD() As Integer)
        'Déclarer les variables de travail
    ...
    ''' 
    Private Sub NTS250K(ByRef NTS As String, ByVal NTSB() As Integer, ByVal pPoint As ESRI.ArcGIS.Geometry.IPoint)
        Try
            'Vérifier si la latitude est inférieure à 68 degré
            If (pPoint.Y < 68) Then
