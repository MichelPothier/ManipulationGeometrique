...
'**
'Nom de la composante : TooDessinerPointSnrc50K.vb
'
'''<summary>
...
'''</remarks>
''' 
Public Class tooDessinerSnrc50k
        ...
        Try
            ...
            Do
                ...
                Do
                    ...
                    oSnrc = New clsSNRC(pPoint, 50000)
                    ...
                    pPoint.X = pPoint.X + oSnrc.DeltaLongitude(pPoint.Y, 50000)
                ...
                pPoint.Y = pPoint.Y - oSnrc.DeltaLatitude(pPoint.Y, 50000)
