...
Friend Class cmdUnionGeometries
    Inherits Button
    ...
    Protected Overrides Sub OnClick()
        ...
        Function()
            'Union de la liste des géométries de travail
            modGeometrieTravail.GeometrieTravail = modGeometrieTravail.UnionListeGeometries(modGeometrieTravail.GeometrieTravail)
