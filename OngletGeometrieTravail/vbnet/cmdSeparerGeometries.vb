...
Friend Class cmdSeparerGeometries
    Inherits Button
    ...
    Protected Overrides Sub OnClick()
        ...
        Function()
            'Séparer les parties de la liste des géométries de travail
            modGeometrieTravail.GeometrieTravail = modGeometrieTravail.SeparerListeGeometries(modGeometrieTravail.GeometrieTravail)
