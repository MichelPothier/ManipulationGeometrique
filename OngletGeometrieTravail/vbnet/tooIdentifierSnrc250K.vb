...
Public Class tooIdentifierSnrc250K
    Inherits MapTool
            ...
            Function()
                ...
                Do
                    ...
                    Do
                        ...
                        point = MapPointBuilder.CreateMapPoint(point.X + snrc.DeltaLongitude(point.Y, 250000), point.Y, envelop.SpatialReference)
                    ...
                    point = MapPointBuilder.CreateMapPoint(envelop.XMin, point.Y - snrc.DeltaLatitude(point.Y, 250000), envelop.SpatialReference)
