...
Friend Class cmdRegrouperGeometries
    Inherits Button
    ...
    Protected Overrides Sub OnClick()
        ...
        Function()
            'Regrouper la liste des géométries de travail
            modGeometrieTravail.GeometrieTravail = modGeometrieTravail.RegrouperListeGeometries(modGeometrieTravail.GeometrieTravail)
