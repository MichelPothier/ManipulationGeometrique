...
'**
'Nom de la composante : cmdDifferenceMultiple.vb
'
'''<summary>
'''Commande qui permet d'effectuer la difference à multiple dimensions entre les géométries de
...
'''</remarks>
''' 
Public Class cmdDifferenceMultiple
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.DifferenceMultiple()
