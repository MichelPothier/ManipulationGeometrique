...
'**
'Nom de la composante : cmdSelectionnerElement
'
'''<summary>
'''Commande qui permet de sélectionner les éléments à partir des géométries de travail en mémoire.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
Public Class cmdSelectionnerElement
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.SelectionnerElement()
