...
'**
'Nom de la composante : cmdGeneraliserExterieur 
'
'''<summary>
'''Commande qui permet de généraliser l'extérieur des éléments de type surface sélectionnés.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdGeneraliserExterieur
    ...
    Protected Overrides Sub OnClick()
        ...
        Dim dLongMin As Double = 25             'Contient la longueur minimum de généralisation.
        ...
        Try
            ...
            'sParametres = InputBox("Entrer la distance latérale, la largeur minimale et la longueur minimale", "Généralisation extérieure d'un polygone", _
            '                       dDistLat.ToString & "," & dLargMin.ToString & "," & dLongMin.ToString)
            sParametres = InputBox("Entrer la largeur minimale, la longueur minimale et la superficie minimale", "Généralisation extérieure d'un polygone", _
            ...
            If sValeur.Length = 3 Then
                ...
                modGeometrieTravail.GeneraliserPolygoneExterieur(dDistLat, dLargMin, dLongMin, dSupMin)
