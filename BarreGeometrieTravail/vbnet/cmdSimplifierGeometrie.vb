...
'**
'Nom de la composante : cmdSimplifierGeometrie.vb
'
'''<summary>
'''Commande qui permet de simplifier les géométries de travail en mémoire.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdSimplifierGeometrie
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.SimplifierGeometrie()
