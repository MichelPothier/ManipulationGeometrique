...
'**
'Nom de la composante : cmdDessinerSommet 
'
'''<summary>
'''Commande qui permet de dessiner dans la fenêtre graphique les sommet des géométries de travail en mémoire.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
Public Class cmdDessinerSommet
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.bDessinerSommet(CType(mpGeometrieTravail, IGeometry), True)
