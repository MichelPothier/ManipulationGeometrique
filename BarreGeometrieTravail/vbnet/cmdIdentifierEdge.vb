...
'**
'Nom de la composante : cmdIdentifierEdge 
'
'''<summary>
'''Commande qui permet d'identifier les Edges sélectionnés dans la vue active et les ajouter dans les géométries de travail en mémoire. 
'''</summary>
'''
'''<remarks>
...
'''</remarks>
Public Class cmdIdentifierEdge
        ...
        Try
            ...
            If Not Hook Is Nothing Then
                ...
                If TypeOf Hook Is IMxApplication Then
                    ...
                    pTopologyExt = CType(gpApp.FindExtensionByCLSID(pTopologyUID), ITopologyExtension)
                    'Définir l'interface pour créer la topologie
                    m_MapTopology = pTopologyExt.MapTopology
                    'Interface contenant l'interface de la topologie
                    m_TopologyGraph = CType(m_MapTopology.Cache, ITopologyGraph4)
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            gpApp.StatusBar.Message(0) = "Identifier les géométries de travail ..."
            modGeometrieTravail.IdentifierEdge()
    ...
    Protected Overrides Sub OnUpdate()
        Try
            ...
            'Vérifier si aucun edge sélectionné
            If m_TopologyGraph.EdgeSelection.Count > 0 Then
                Enabled = True
            End If
        Finally
            '
