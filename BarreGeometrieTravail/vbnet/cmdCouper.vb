...
'**
'Nom de la composante : cmdCouper.vb
'
'''<summary>
'''Commande qui permet de couper les éléments sélectionnés selon les géométries de travail de type ligne en mémoire.
'''</summary>
'''
'''<remarks>
...
Public Class cmdCouper
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.Couper(True, True)
