...
'**
'Nom de la composante : cmdZoomGeometrie 
'
'''<summary>
'''Commande qui permet d'effectuer un Zoom dans le fenêtre graphique à partir de l'étendue des
'''géométries de travail en mémoire.
'''</summary>
'''
'''<remarks>
...
Public Class cmdZoomGeometrie
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.ZoomGeometrieTravail(CType(mpGeometrieTravail, IGeometry))
            ...
            'Afficher les géométries de travail
            modGeometrieTravail.bDessinerGeometrie(CType(mpGeometrieTravail, IGeometry), True, _
