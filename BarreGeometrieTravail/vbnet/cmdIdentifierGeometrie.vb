...
'**
'Nom de la composante : cmdIdentifierGeometrie.vb
'
'''<summary>
'''Commande qui permet d'identifier les géométries de travail en mémoire à partir des éléments
...
'''</remarks>
''' 
Public Class cmdIdentifierGeometrie
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.IdentifierGeometrie()
