...
Public Class cmdGeneraliserLigne
    ...
    Protected Overrides Sub OnClick()
        ...
        Dim dLongGenMin As Double = 25              'Contient la longueur minimale de généralisation.
        Dim dLongMin As Double = 1250               'Contient la longueur minimale d'une ligne.
        Dim iMethode As Integer = 0                 'Contient la méthode de généralisation 0:Droite, 1:Gauche.
        ...
        Try
            ...
            sParametres = InputBox("Entrer la largeur et la longueur minimale de généralisation, la longueur minimale d'une ligne et la méthode (0:Droite/1:Gauche)", "Généralisation d'une polyligne", _
