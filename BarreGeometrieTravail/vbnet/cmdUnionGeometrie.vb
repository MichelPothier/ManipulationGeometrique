...
'**
'Nom de la composante : cmdUnionGeometrie.vb
'
'''<summary>
'''Commande qui permet d'effectuer l'union entre les géométries de travail en mémoire.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdUnionGeometrie
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.UnionGeometrie()
