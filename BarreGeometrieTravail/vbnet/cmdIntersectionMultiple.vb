...
'**
'Nom de la composante : cmdIntersectionMultiple.vb
'
'''<summary>
'''Commande qui permet d'effectuer l'intersection à multiple dimensions entre les géométries de
'''travail et les éléments sélectionnés.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdIntersectionMultiple
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            modGeometrieTravail.IntersectionMultiple()
